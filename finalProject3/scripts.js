document.addEventListener("DOMContentLoaded", () => {
  ...
  const colours = [
    ...
    "#a855f7",
    "#9333ea",
    "#7e22ce", // Purple shades
    "#ec4899",
    "#f472b6",
    "#f9a8d4",
    "#fbcfe8", // Pink-purple shades
    "#e879f9",
    "#f0abfc",
    "#f5d0fe", // Light purple shades
  ];
  ...
  const modalImg = document.getElementById("memeModalImg");
  const closeBtn = document.querySelector(".meme-close");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const sidebar = document.querySelector(".retro-sidebar");

  if (toggle && sidebar) {
    toggle.addEventListener("click", function () {
      // Toggle the nav-open class correctly
